...
dist: main.go plugin.go plugin.yaml webhook.go
	GOOS=linux GOARCH=amd64 go build -o mattermost-plugin-sonarqube plugin.go main.go webhook.go
	tar czvf plugin.tar.gz mattermost-plugin-sonarqube plugin.yaml
